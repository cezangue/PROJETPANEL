...
st.set_page_config(page_title="Page", page_icon="🏠")

# Définir le titre de l'application
st.title("Page d'Accueil: TAGNE TCHINDA Page vous souhaite la bienvenue dans l'espace d'analyse des effets du changement climatique en afrique sub-saharienne")
